...
There is no clear evidence of any non-linear effects of the covariates looking at the studentized residuals.However, to investigate this further we made a plot of the conditional mean  there seems to be a tendency of the residuals lying above zeros in the left of the plot and then more below zero as we move to the right, which could be a sign of autocorrelated errors.
...
Assuming that the first 900 null-hypotheses true, and last 100 false. We first investigate the number of type 1 and type 2 errors
```{r,eval = TRUE}
